...
function Field({
  ...
  return (
    // A Field can be nested inside FieldSet, so another fieldset is not always valid.
    // biome-ignore lint/a11y/useSemanticElements: Preserve the composable field structure.
    <div
      role="group"
      data-slot="field"
